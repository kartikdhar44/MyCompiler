...
public class Interpretor implements Expr.Visitor<Object>,Stmt.Visitor<Void> {
    ...
    @Override
    public Void visitBinaryStmt(Stmt.Binary stmt) {
        return null;
    }

    @Override
    public Void visitGroupingStmt(Stmt.Grouping stmt) {
        return null;
    }

    @Override
    public Void visitLiteralStmt(Stmt.Literal stmt) {
        return null;
    }

    @Override
    public Void visitUnaryStmt(Stmt.Unary stmt) {
        return null;
    }
